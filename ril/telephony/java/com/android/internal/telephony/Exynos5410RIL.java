...
/**
 * RIL customization for Galaxy S4 (Exynos) 
 *
 * {@hide}
 */
public class Exynos5410RIL extends RIL {

    private static final int RIL_REQUEST_DIAL_EMERGENCY = 10016;

    private Message mPendingGetSimStatus;

    public Exynos5410RIL(Context context, int networkMode, int cdmaSubscription) {
        super(context, networkMode, cdmaSubscription, null);
        mQANElements = 6;
    }

    public Exynos5410RIL(Context context, int preferredNetworkType,
